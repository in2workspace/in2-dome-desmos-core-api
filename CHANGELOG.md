...
## [Released]: v2.0.21
- Don't check lifecycleStatus for multiple entity types
...
## [Released]: v2.0.13
- Bypass quota lifecycle-status check for P2P synchronization

## [Released]: v2.0.12
- Add quotes replication

## [Released]: v2.0.11
- Fix problem with large entities list

## [Released]: v2.0.10
- Improve logs for better debugging and monitoring of the application
...
## [Released]: v2.0.7
- Fix type usage in policy service when it's null

## [Released]: v2.0.6
- Correct usageSpecification entity type

## [Released]: v2.0.5
- Add property validations to avoid errors when the application starts with wrong configuration
- Improve logs for better debugging and monitoring of the application
- Refactor some functions

## [Released]: v2.0.4
- Remove product order lifecyclestatus validation

## [Released]: v2.0.3
- Fix dlt subscriptions url on test and prd profiles

## [Released]: v2.0.2
- Delete reset on startup when dataSync fails

## [Released]: v2.0.1
- Improve different version error catch

## [Released]: v2.0.0
- Update EndpointConstants
- new dynamic var on api.version for versions path
